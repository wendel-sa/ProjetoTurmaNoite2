<?php 
/*Arquivo que irá adicionar os comentarios no banco de dados */
...
VALUES ('$id_usuario', '$id_produto', '$comentario', '$nota', '$dataComentario')";

//se o comando for executado com sucesso
if($db->exec($inserirComentario)){
    //redirecionar para a pagina do produto
   // header("Location: ../produtos/item.php?u_id=$id_produto");
